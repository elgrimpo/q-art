export default function sitemap() {
  return [
    ...
    { url: 'https://www.qr-ai.co/styles/watercolor', lastModified: new Date('2026-07-15'), priority: 0.6 },
    { url: 'https://www.qr-ai.co/styles/ukiyo-e',    lastModified: new Date('2026-07-15'), priority: 0.6 },
