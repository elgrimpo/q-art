 ...
 *
 * Linear map: -2 -> 0.0 (most artistic), 0 -> 0.5, +2 -> 1.0 (most scannable).
 */
...
/**
 * Convert a slider value (-2..+2) to a backend qr_weight (0..1).
...
/**
 * Convert a backend qr_weight (0..1) back to slider value (-2..+2).
